<?php     
if ((!isset($_GET["payment_status"]) || $_GET['payment_status'] == "") || (isset($_POST["payment_status"]) && $_POST['payment_status'] == "failure"))
{
    require('crear_preferencia.php');
}
?>
                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <?php if (isset($_GET["payment_status"])): ?>                                        
                                        <?php 
                                            $payment_status=($_GET['payment_status'] == "success" || $_GET['payment_status'] == "pending")?$_GET['payment_status']:'other';

                                            if($payment_status == "success"):
                                                include('./transaccion_exitosa.php');
                                            elseif ($payment_status == "pending"):
                                                echo '<br><br>
                                                    <h3 style="color: orange">La operación se pudo realizar correctamente pero <br>el pago quedó pendiente de confirmación.</h3>
                                                    <form>
                                                ...
                                                echo '<br><br>
                                                <h2 style="color: red">Ocurrió un error al realizar el pago.</h2>
                                                <form>
                                                    <button type="submit" class="mercadopago-button" formaction="./index.php">Volver a la tienda</button>
                                                </form>';
                                            endif;
